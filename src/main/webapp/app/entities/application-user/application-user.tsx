  ...
  return (
    <div>
      <h2 id="application-user-heading" data-cy="ApplicationUserHeading">
        <Translate contentKey="telecomProviderApp.applicationUser.home.title">Application Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="telecomProviderApp.applicationUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/application-user/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="telecomProviderApp.applicationUser.home.createLabel">Create new Application User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {applicationUserList && applicationUserList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="telecomProviderApp.applicationUser.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('wallet')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('wallet')} />
                </th>
                <th>
            ...
            <tbody>
              {applicationUserList.map((applicationUser, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{applicationUser.wallet}</td>
                  <td>{applicationUser.internalUser ? applicationUser.internalUser.login : ''}</td>
                  <td>
                    {applicationUser.chosenMobilePlan ? (
                      <Link to={`/mobile-plan/${applicationUser.chosenMobilePlan.id}`}>{applicationUser.chosenMobilePlan.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="telecomProviderApp.applicationUser.home.notFound">No Application Users found</Translate>
            </div>
          )
        )}
      </div>
