...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOBILEPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MOBILEPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MOBILEPLAN actions', async () => {
      const arg = { id: 15438 };
    ...
    it('dispatches UPDATE_MOBILEPLAN actions', async () => {
      const arg = { id: 15438 };
    ...
    it('dispatches PARTIAL_UPDATE_MOBILEPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MOBILEPLAN actions', async () => {
      const arg = 42666;
