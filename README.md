...
- [ ] UI improvements
- [ ] Tech debt : as Mui is used, remove and refactor other styling packages
...
To build the final jar and optimize the telecomProviderApp application for production, run:
